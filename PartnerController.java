...
public class PartnerController {
    ...
    // Nem biztos, hogy itt a legjobb! Hova redirectáljon?

    @GetMapping("/delete/{id}")
    public String deletePartner(@PathVariable("id") Integer id, Model model) {
        model.addAttribute("partner", partnerService.getPartnerById(id));
        return "partner-delete" ;
    }

    @PostMapping("/delete/{id}")
    public String deletePartner(@ModelAttribute("partner") Partner partner,@PathVariable("id") Integer id){
