...
INSERT INTO `bar` VALUES (5,'Serving those that live the vacation lifestyle with diverse, high quality experiences around the world.','Marriott Vacation Club',13,'bar.jpg'),(6,'Napközben a Sky Bar maga a nyugalom oázisa: üzleti találkozók vagy akár barátokkal együtt töltött idő ideális helyszíne a város felett, zavartalan légkörben.','SkyBar – A város felett!',15,'skybar-a-varos-felett-normal10575.jpg'),(7,'','Elit Bar',21,'elit.jpg');
...
INSERT INTO `facilities` VALUES (1,'Jacuzzis use hydromassage to stimulate muscles.','Jacuzzi',50,7,13),(2,'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.','Wellness',250,9,14);
...
INSERT INTO `hotel` VALUES (7,'Enriching experiences thoughtfully crafted by associates who truly love what they do.','JW Marriott',13,'jw-marriott-hotel-mumbai.jpg'),(8,'Rare estates, set apart from the world, where heartfelt care is felt at every turn','Ritz-Carlton Reserve',13,'phulay_bay_ritz_carlton_hotel_review-56.jpg'),(9,'','Silver Garden ',14,'IMG_1836-másolat-2.jpg');
...
LOCK TABLES `hotel_bar` WRITE;
/*!40000 ALTER TABLE `hotel_bar` DISABLE KEYS */;
INSERT INTO `hotel_bar` VALUES (2,'','523 Bar',7,13,'our-restaurant-with-big.jpg');
...
INSERT INTO `hotel_restaurant` VALUES (1,' Above the city! Is the first roof bar in Romania, based on a new concept that will impress you with the unique design and the special atmosphere.','SkyBar',7,13,'0-big.jpg');
...
LOCK TABLES `menu_book` WRITE;
/*!40000 ALTER TABLE `menu_book` DISABLE KEYS */;
INSERT INTO `menu_book` VALUES (4,' Above the city! Is the first roof bar in Romania, based on a new concept that will impress you with the unique design and the special atmosphere.','Mojito',25,NULL,7,2,NULL,13,NULL,NULL,'mojito.jpg'),(5,'vodka, peach schnapps, orange juice, and cranberry juice','SexOnTheBeach',27,NULL,7,2,NULL,13,NULL,NULL,'sex-on-the-beach.jpg'),(6,'Big juicy hamburger patties don’t need a lot of ingredients or extras. With just a few great tips, these patties are perfect for cookouts all year ’round!','Hamburger',90,NULL,7,NULL,1,13,NULL,NULL,'hamburger.jpg'),(7,'A creamy soup with langoustines, mussels scallops and fennel','SEAFOOD SOUP',110,NULL,NULL,NULL,NULL,16,NULL,5,NULL);
...
INSERT INTO `partner` VALUES (13,'St. Regis','78945','meriott@gmail.com','Marriott International Inc.','$2a$10$mHsQbl2pL9LezXXwwNvL2u.PRNYTYSf3A0uGCLZXNytZBDDSbIwcu','2154','345698746','Marriott-International.jpg'),(14,'Siófok','62626154','info@silvergarden.hu','Silver Garden Siófok','$2a$10$BDlWNZPr.7KIcB3oeysI1eA1RD2noOqHsmIdrmRkzTehVVRhQwspy','6446','036789546','medence-1024x675.jpg'),(15,'Székelyudvarhely','5444','office@kukullo.ro','Hotel Küküllő*** ','$2a$10$RI/yxarynrzsUq8bfBV70ufhrWJP8rnJ3pkLeCQHrjwssVOM7qOjy','RO15151','0266213963','nn_kukullo_dron-8.jpg'),(16,'Reykjavik','650121-1980','reception@hotelisland.is','Hotel Ísland – Spa & Wellness Hotel','$2a$10$m1zVvIYxYrwxktB014ukZusG6nfVbRJw6n1Fs7GMp9qx7TdTXavTa','140029','(+354) 595-7000 ','izlandh.jpg'),(17,'Inter Hotel, 4027, Debrecen, Böszörményi út 2.','09 09 034946','info@interhotel.hu','Inter Hotel Debrecen','$2a$10$EHo0NiFWoSMMrs96n9L5SeEwLfCp9fYhffNCzyTrPfuxNrXLbw9Te','32228456-2-09','+36 30 293 54 06','debrecen.jpg'),(21,'Erdely','1235456','moka@moka.com','Moka','$2a$10$yfUSTwqL2.2f5vyTI6NJ/uv7TI/kUCIKho7qxhu7aC3O7.u.PIAf6','12345','0747969570','moka-logo.png');
...
LOCK TABLES `partner_admin` WRITE;
/*!40000 ALTER TABLE `partner_admin` DISABLE KEYS */;
INSERT INTO `partner_admin` VALUES (3,'Barbara','Reception','+36 70 4089437',14),(4,'Krisztina','Manager','0749969578',15);
...
INSERT INTO `restaurant` VALUES (3,'Enabling ambitious travelers to succeed through an environment that inspires creativity and fosters connections.','Courtyard',13,'Restaurant_Näsinneula.jpg'),(4,'Étterem a város szívében','Menta Bistro',15,'23184-menta-bistro-album182.jpg'),(5,'Hekla Restaurant and bar is a fresh, modern restaurant that opened its door in May 2021 at Hótel Ísland. ','Hekla Restaurant',16,'izlandre.jpg'),(6,'Engedje, hogy elkápráztassuk ízletes ételeinkkel és kellemes környezetünkkel az Inter Hotel Debrecen éttermében!','ÉTTEREM',17,'debetterem.jpg'),(7,' kóstold meg a friss, ropogós ízeket, amelyeket csak a Crispeace tud nyújtani','CrisPeace',21,'crispeace.jpg');
...
INSERT INTO `room` VALUES (3,180,2,'B5',7,13,'room.jpg'),(4,190,4,'4',9,14,'cssladi.jpg');
...
INSERT INTO `users` VALUES (1,'2023-11-29','makicica22@gmail.com','MArika','Ambrus','$2a$10$vYiEjaNdwcipJBSQlzPGm.Unn9KKGQ7UB2d3JXfyCMlPT9NgIFZqC','123456','0747969570','Mr.',NULL);
